...
const ServiceSection = () => {
    return (
        <section id="service" className="general-spacing">
            <div className="flex flex-col items-center justify-center space-y-10 lg:flex-row lg:space-y-0 responsive">
                <div data-aos="zoom-in-right" className="object-cover object-center w-full overflow-hidden rounded-lg shadow-lg lg:w-2/5 lg:flex-shrink-0 lg:order-2 lg:ml-10 xl:ml-20">
                ...
                <div data-aos="zoom-in-left" className="">
                    <div className="mb-8">
                        <div  className="flex items-center mb-2 space-x-2 font-semibold text-entrust-blue">
                            ...
                            <span className="text-sm text-entrust-blue md:text-base">Our Service</span>
                        </div>
                        <h2 className="mb-4 text-2xl font-bold md:text-4xl lg:mb-6">IT Outsourcing</h2>
