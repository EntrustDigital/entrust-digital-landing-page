            ...
            <div className="">
                <div className="flex flex-col space-y-10 lg:flex-row lg:space-y-0 lg:space-x-10 xl:space-x-20 responsive ">
                    <div className="flex flex-col items-center justify-center text-center lg:items-start lg:text-left">
                        ...
                        <h1  data-aos="fade-up" className="mb-6 text-4xl font-bold leading-tight text-white xl:mb-10lg:mb-8 md:text-5xl md:leading-tight xl:leading-tight ">The Best Technology Talent Provider from Indonesia</h1>
                        <Button  data-aos="fade-up" className="md:btn--base" buttonSize="md" buttonColor="red" onClick={()=>goToSection('#about')}>Read More</Button>
                    </div>
