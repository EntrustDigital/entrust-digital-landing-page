    ...
    return (
        <section id="about" className="general-spacing">
            <div className="flex flex-col items-center space-y-10 lg:flex-row lg:space-y-0 responsive">
                <div data-aos="zoom-in-left" className="relative w-full lg:h-full lg:w-2/5 lg:flex-shrink-0 lg:mr-10 xl:mr-20">
                ...
                <div data-aos="zoom-in-right" className="">
                    <div className="mb-8">
                        ...
                        <div className=" text-entrust-gray-800">
                            <p className="leading-loose">We provide you with our professional team which are adapt with all the latest technologies. Our services can assist you with quality IT talent to be your valuable solution.  Many of our clients needs to improve their IT team resources so they can reduce consuming-time and focus on its core business. </p>
                        </div>
                    </div>
                    <Button  className="md:btn--base" buttonSize="md" buttonColor="red" onClick={()=>goToSection('#service')}>Our Service</Button>
                </div>
            </div>
        </section>
    )
